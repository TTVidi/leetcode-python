...
# traversal of the tree.  (Recall that a node is a leaf if and only if it has 0 children.) The value of each non-leaf
# node is equal to the product of the largest leaf value in its left and right subtree respectively. Among all
...
if __name__ == '__main__':
    s = Solution()
    print(s.mctFromLeafValues([1, 4, 5, 789, 2]))
